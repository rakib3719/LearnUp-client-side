...
const Errror = () => {
    ...
    return (
           ...
           <div className="flex items-center min-h-svh p-16 dark:bg-gray-50 dark:text-gray-800">
	<div className="container flex flex-col items-center justify-center px-5 mx-auto my-8">
		<div className="max-w-md text-center">
			{ error.status === 404 ? <h2 className="mb-8 font-extrabold text-9xl dark:text-gray-400">
