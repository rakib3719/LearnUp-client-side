...
.then(data=> console.log(data.data))
    ...
    return (
        <div className={`${!isDarkMode && 'bg-gray-100'} min-h-screen py-12 px-4 sm:px-6 lg:px-8 lg:flex justify-between gap-16 items-center`}>
         ...
         <textarea disabled value={data.note} name="" id="" className={`mt-4 block ${!isDarkMode && 'bg-[#F9E0AE]'} p-4 w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500`}></textarea>
          </div>
          </div>
